...
public class bibliotecas_bibliobuses extends AppCompatActivity implements ListAdapter.OnNoteListener{
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_bibliotecas_bibliobuses);

            //Menu de navegación
            bottomNavigationView = findViewById(R.id.bottomNavigationView);
            bottomNavigationView.setSelectedItemId(R.id.bibliotecas_bibliobuses);
            ...
            service.listBibliobuses_Bibliotecas(null,null,null)
    ...
    public void onNoteClick(int position) {
        if (result.get(position).getAddress().getStreetAddress().contains("Servicio itinerante")){
            Log.d("ERROR", "onNoteClick: No Funciona porque no es la misma clase");
        }else {
