...
public class SalasEstudio extends AppCompatActivity implements ListAdapter.OnNoteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salas_estudio);
        ...
        service.listSlasLectura(null,null,null)
        ...
        bottomNavigationView.setSelectedItemId(R.id.salasEstudio);
